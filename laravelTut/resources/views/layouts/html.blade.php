...
<head>
    ...
    <!-- Site Icons -->
    <link rel="shortcut icon" href="#" type="{{ URL::to('/') }}/public/image/x-icon" />
    <link rel="apple-touch-icon" href="#" />

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{ URL::to('/') }}/public/css/bootstrap.min.css" />
    <!-- Pogo Slider CSS -->
    <link rel="stylesheet" href="{{ URL::to('/') }}/public/css/pogo-slider.min.css" />
    <!-- Site CSS -->
...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <header class="top-header">
        <nav class="navbar header-nav navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.html"><img src="{{ URL::to('/') }}/public/img/logo.png" alt="image"></a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
                        ...
                        <li><a class="nav-link" href="{{ url('/aboutus') }}">Aboutus</a></li>
                ...
                <div class="search-box">
                    ...
                    <a class="search-btn">
                        <img src="{{ URL::to('/') }}/public/images/search_icon.png" alt="#" />
                    </a>
                </div>
            </div>
        </nav>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 margin-bottom_30">
				   <img src="{{ URL::to('/') }}/public/img/f_logo.png" alt="#" />
				</div>
               <div class="col-xl-6 white_fonts">
					...
					<div class="col-md-12 white_fonts margin-bottom_30">
					   <h3>Contact Us</h3>
                        ...
                        <div class="col-md-4">
                            <div class="full icon">
                                <img src="{{ URL::to('/') }}/public/images/social1.png">
                            </div>
                        ...
                        <div class="col-md-5">
                            <div class="full icon">
                                <img src="{{ URL::to('/') }}/public/images/social2.png">
                            </div>
                            <div class="full white_fonts">
                        ...
                        <div class="col-md-3">
                            <div class="full icon">
                                <img src="{{ URL::to('/') }}/public/images/social3.png">
                            </div>
                            <div class="full white_fonts">
                                <p>+7586656566
                                    <br>+7586656566</p>
    ...
    <script src="{{ URL::to('/') }}/public/js/jquery.pogo-slider.min.js"></script>
    <script src="{{ URL::to('/') }}/public/js/slider-index.js"></script>
    <script src="{{ URL::to('/') }}/public/js/smoothscroll.js"></script>
    <script src="{{ URL::to('/') }}/public/js/form-validator.min.js"></script>
    <script src="{{ URL::to('/') }}/public/js/contact-form-script.js"></script>
    <script src="{{ URL::to('/') }}/public/js/isotope.min.js"></script>
    <script src="{{ URL::to('/') }}/public/js/images-loded.min.js"></script>
